              ...
              <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                <div class="card-body">
                  <div class="shipping-address-form">
                    @if (!empty(Auth::user()->diaChi) && is_array(Auth::user()->diaChi))
                    @foreach (Auth::user()->diaChi as $diachi)
                    <div class="address-block">
                      <p><input type="text" name="tendiachi" placeholder="Tên địa chỉ" value="{{$diachi['tenDiaChi']}}"></p>
                      <p><input type="text" name="sonha" placeholder="Số nhà" value="{{$diachi['soNha']}}"></p>
                      <p><input type="text" name="duong" placeholder="Đường" value="{{$diachi['duong']}}"></p>
                      <p><input type="text" name="phuong" placeholder="Phường" value="{{$diachi['phuong']}}"></p>
                      <p><input type="text" name="quan" placeholder="Quận" value="{{$diachi['quan']}}"></p>
                      <p><input type="text" name="thanhpho" placeholder="Thành phố" value="{{$diachi['thanhPho']}}"></p>
                    </div>
                    @endforeach
                    @else
                    <div class="address-block">
